...
\textbf{LazyData}: true\\
\textbf{Depends}: R (\textgreater{}= 3.6.2), plyr, tools,
scatterplot3d.\\
\textbf{RoxygenNote}: 7.0.2\\
\textbf{Suggests}:devtools, knitr, rmarkdown.\\
\textbf{VignetteBuilder}: knitr.\\
\textbf{URL}: \url{https://github.com/bioinfoDZ/zhengLab353/Stereo3D}\\
\textbf{BugReports}:
\url{https://github.com/bioinfoDZ/zhengLab353/Stereo3D/issues}
\end{abstract}
